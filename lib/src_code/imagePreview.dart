...
class PreviewImageState extends State<PreviewImage> {
 ...
 @override
  ...
  List<DropdownMenuItem<FileType>> buildDropdownMenuItems(List _fileType){
    List <DropdownMenuItem<FileType>> items = List();
    for (FileType imageType in _fileType){
      items.add(
        DropdownMenuItem(
          value: imageType,
  ...
  onChangeDropdownItem(FileType file){
    setState(() {
     _file=file;
    });
  }
